...
import { IconArrowsRightLeft, IconQuestionCircle, IconShare, IconStar } from "@tabler/icons-react";
...
function ProductInfo(){
    ...
    return <StyledProductInfo item md={5.5} xs={12} className='product-info' >
